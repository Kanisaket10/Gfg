<h2><a href="https://www.geeksforgeeks.org/problems/find-missing-and-repeating2512/1?utm_source=geeksforgeeks&utm_medium=article_practice_tab&utm_campaign=article_practice_tab">Missing And Repeating</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an unsorted array <strong><em>arr</em></strong> of of positive integers. One number '<strong>A</strong>' from set {1, 2,....,N} is missing and one number '<strong>B</strong>' occurs twice in array. Find numbers <strong>A</strong> and <strong>B</strong>.<br></span></p>
